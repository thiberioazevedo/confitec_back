            ...
            if (env.IsDevelopment())
            {
                services.AddSwaggerGen(c =>
                {
                    c.SwaggerDoc("v1", new OpenApiInfo
                    {
                        ...
                        Description = "",
                        Contact = new OpenApiContact { Name = "Thiberio Azevedo Barreto", Email = "thiberio.azevedo@gmail.com", Url = new Uri("https://linkedin.com/in/thiberio-a-34bb9453") },
                    ...
                    c.SwaggerDoc("v2", new OpenApiInfo
                    {
                        ...
                        Title = "ASPNET Core DDD Project",
                        Description = "",
                        Contact = new OpenApiContact { Name = "Thiberio Azevedo Barreto", Email = "nguyentrucxjnh@gmail.com", Url = new Uri("https://linkedin.com/in/thiberio-a-34bb9453") },
                        License = new OpenApiLicense() { Name = "MIT", Url = new Uri("https://opensource.org/license/mit/") }
                    });
