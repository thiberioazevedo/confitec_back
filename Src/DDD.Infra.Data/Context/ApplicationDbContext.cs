...
namespace DDD.Infra.Data.Context
{
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new UsuarioHistoricoEscolarMap());
        ...
        private void UpdateTimestamps(List<EntityEntry> entries)
        {
            ...
            var currentUserId = new Guid(user.GetClaimsIdentity().Where(i => i.Type == ClaimTypes.NameIdentifier).FirstOrDefault().Value);
